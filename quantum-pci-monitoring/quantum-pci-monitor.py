...
def main():
    ...
    if realistic_api_path.exists():
        ...
        print("🔧 Инициализация мультиплексора I2C и всех датчиков...")
        print("="*80)

        # Запускаем реалистичный API (инициализация мультиплексора происходит внутри)
        try:
            ...
            print("="*80)
            print("📊 Realistic Dashboard: http://localhost:8080/realistic-dashboard")
