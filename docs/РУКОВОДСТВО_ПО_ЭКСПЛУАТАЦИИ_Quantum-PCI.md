...
### 4.11 Тест автономного хранения 1PPS (24 часа)
...
### 4.13 Тест автономного хранения 1PPS (24 часа) - расширенный
...
### 4.7 Тест PTP с одним клиентом (phc2sys) - внутренняя антенна
...
### 4.8 Тест PTP с одним клиентом (phc2sys) - внешняя антенна
...
### 4.9 Тест PTP с одним клиентом (ts2phc) - внутренняя антенна
...
### 4.10 Тест PTP с одним клиентом (ts2phc) - внешняя антенна
...
### 23. Безопасность и соответствие стандартам
...
### 24. Приложение: примеры systemd‑юнитов
...
### 25. Ссылки на материалы репозитория
...
### 27. Консолидированные инструкции из каталога docs
...
### 28. Сводка: установка и обновление драйвера
...
### 29. Сводка: LinuxPTP (ptp4l, phc2sys, ts2phc)
...
### 30. Сводка: Chrony (работа с PHC/PPS)
...
### 31. Сводка: детальная конфигурация драйвера и sysfs
...
### 32. Сетевая оптимизация для PTP
...
### 26. Полезные ссылки и поддержка
...
5. **Мониторинг** (разделы 18-21): Диагностика, обслуживание, интеграция, устранение неполадок
6. **Оптимизация** (разделы 22-23): Производительность, безопасность
7. **Справочники** (разделы 24-25): Команды, ссылки, поддержка
