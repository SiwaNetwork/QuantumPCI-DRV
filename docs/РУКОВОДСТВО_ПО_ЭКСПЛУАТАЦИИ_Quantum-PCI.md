...
### 33. Приложение A: Быстрый старт — полный текст
...
### 34. Приложение B: Установка и настройка — полный текст
...
### 35. Приложение C: Документация по LinuxPTP — полный текст
...
### 36. Приложение D: Архитектура драйвера — полный текст
...
### 37. Приложение E: Полное руководство по Chrony — полный текст
...
### 38. Приложение F: Детальная конфигурация — полный текст
