...
|--------------|-------------------------|----------|
| **QUANTUM-Q-01** | Кварцевый генератор | Уход времени в автономном режиме не более ±0.6мкс в сутки (стандартная поставка) |
| **QUANTUM-Q-02** | Кварцевый генератор | Уход времени в автономном режиме не более ±1.7мкс в сутки (экономичная поставка) |
| **QUANTUM-Q-03** | Высокоточный кварцевый генератор | Уход времени в автономном режиме не более ±0.017мкс в сутки (премиум поставка) |
| **QUANTUM-R-01** | Рубидиевый стандарт | Уход времени в автономном режиме не более ±0.0086мкс в сутки (поставка под заказ) |
| **QUANTUM-C-01** | Цезиевый стандарт | Уход времени в автономном режиме не более ±0.26мкс в сутки (поставка под заказ) |
...
- **Уход часов в автономном режиме (QUANTUM-Q-01)**: не более ±0.6 мкс в сутки
- **Уход часов в автономном режиме (QUANTUM-Q-02)**: не более ±1.7 мкс в сутки
- **Уход часов в автономном режиме (QUANTUM-Q-03)**: не более ±0.017 мкс в сутки
- **Уход часов в автономном режиме (QUANTUM-R-01 рубидиевый)**: не более ±0.0086 мкс в сутки
- **Уход часов в автономном режиме (QUANTUM-C-01 цезиевый)**: не более ±0.26 мкс в сутки
...
- **Модели**: SiTime SiT5503, SiTime SiT5711
- **Тип**: Кварцевый OCXO
- **Частотная стабильность**: ±5,00E-9 (±5 ppb) [-40...+85°C]
- **Частотный дрейф за сутки**: ±7,00E-10 (±0,7 ppb)
- **Уход времени в автономном режиме**: не более ±0.6 мкс в сутки
...
- **Модели**: AOCJYR-10.000МГц-M5625LF, Rakon RFPO45
- **Тип**: Кварцевый OCXO
- **Частотная стабильность**: ±2,50E-8 (±25 ppb) [-40...+85°C]
- **Частотный дрейф за сутки**: ±2,00E-9 (±2 ppb)
- **Уход времени в автономном режиме**: не более ±1.7 мкс в сутки
...
- **QUANTUM-Q-01**: Кварцевый генератор (стандартная поставка) - ±0.6 мкс в сутки
- **QUANTUM-Q-02**: Кварцевый генератор (экономичная поставка) - ±1.7 мкс в сутки
- **QUANTUM-Q-03**: Высокоточный кварцевый генератор (премиум поставка) - ±0.017 мкс в сутки
- **QUANTUM-R-01**: Рубидиевый стандарт (поставка под заказ) - ±0.0086 мкс в сутки
- **QUANTUM-C-01**: Цезиевый стандарт (поставка под заказ) - ±0.26 мкс в сутки
