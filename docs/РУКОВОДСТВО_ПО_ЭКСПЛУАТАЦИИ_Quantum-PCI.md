...
### 2. Комплект поставки и коды заказа

#### Сведения о комплектности изделия
...
Для реализации механизма хранения времени используются встроенные атомные часы на основе различных генераторов, включая атомные стандарты, многоканальный ГНСС-приемник и программируемую ПЛИС (FPGA). Задача механизма времени заключается в интерполяции последовательных импульсов PPS с наносекундной точностью.
...
**8.1.1** Срок службы – 10 лет с момента приемки представителем ОТК на предприятии-изготовителе.

**8.1.2** Указанные срок службы и срок хранения действительны при соблюдении потребителем требований настоящего паспорта.

#### 8.2. Гарантии изготовителя (поставщика)

**8.2.1** Предприятие-изготовитель (поставщик) гарантирует соответствие требований при соблюдении потребителем условий и правил хранения, транспортирования и эксплуатации, установленных настоящим паспортом.

**8.2.2** Гарантийный срок эксплуатации – пять лет с момента ввода блока в эксплуатацию.

**8.2.3** Гарантийный срок хранения, предшествующий гарантийному сроку эксплуатации – три года с момента приемки изделия на предприятии-изготовителе.

**8.2.4** Предприятие изготовитель (поставщик) в пределах срока действия гарантий поставщика производит безвозмездное восстановление.

---

### 9. Режимы работы и сценарии эксплуатации
...
### 13. Установка и загрузка драйвера

#### 13.1. Установка системы и настройка (CentOS)
...
#### 13.2. Установка и загрузка драйвера (Ubuntu)
...
### 15. Настройка системного времени: варианты
...
### 20. Интеграция с различными системами
...
### 21. Расширенное устранение неполадок
...
### 23. Тестирование и валидация

#### Бенчмарки и тестирование

### 23.1 Тест автономного хранения 1PPS (24 часа)
...
### 23.2 Тест автономного хранения 1PPS (24 часа) - расширенный
...
### 23.3 Тест PTP с одним клиентом (phc2sys) - внутренняя антенна
...
### 23.4 Тест PTP с одним клиентом (phc2sys) - внешняя антенна
...
### 23.5 Тест PTP с одним клиентом (ts2phc) - внутренняя антенна
...
### 23.6 Тест PTP с одним клиентом (ts2phc) - внешняя антенна
...
### 23.7 Тестирование PTM (Precision Time Measurement)
...
### 25. Консолидированные инструкции из каталога docs
...
### 26. Сводка: установка и обновление драйвера
...
### 27. Сводка: LinuxPTP (ptp4l, phc2sys, ts2phc)
...
### 28. Сводка: Chrony (работа с PHC/PPS)
...
### 29. Сводка: детальная конфигурация драйвера и sysfs
...
### 30. Сетевая оптимизация для PTP
...
### 32. Приложение: примеры systemd‑юнитов
...
### 33. Полезные ссылки и поддержка
...
### Структура документа:
1. **Введение** (разделы 1-4): Описание, комплектация, характеристики, безопасность
2. **Архитектура** (разделы 5-8): Устройство, интерфейсы, индикация, ресурсы
3. **Установка** (разделы 9-13): Режимы, конфигурация, установка, драйвер
4. **Эксплуатация** (разделы 14-17): GNSS, время, PTP, NTP
5. **Мониторинг** (разделы 18-22): Диагностика, обслуживание, интеграция, устранение неполадок, производительность
6. **Тестирование** (раздел 23): Валидация и тестирование системы
7. **Безопасность** (раздел 24): Соответствие стандартам
8. **Справочники** (разделы 25-33): Инструкции, команды, ссылки, поддержка
