...
|--------------|-------------------------|----------|
| **QANTUM-O** | Генератор OCXO-HQ | Уход времени в автономном режиме не более ±1.5мкс в сутки (стандартная поставка) |
| **QANTUM-T** | Генератор OCXO обычный | Уход времени в автономном режиме не более ±20мкс в сутки (стандартная поставка) |
| **QANTUM-RB** | Рубидиевый генератор | Уход времени в автономном режиме не более ±0.3мкс в сутки (поставка под заказ) |
| **QANTUM-CS** | Цезиевый генератор | Уход времени в автономном режиме не более ±0.3мкс в сутки (поставка под заказ) |
| **QANTUM-CS+** | Цезиевый генератор с низким фазовым дрожанием | Уход времени в автономном режиме не более ±0.5мкс в сутки (поставка под заказ) |
...
- **Уход часов в автономном режиме (обычный OCXO)**: не более ±20 мкс в сутки
- **Уход часов в автономном режиме (OCXO HQ)**: не более ±1.5 мкс в сутки
- **Уход часов в автономном режиме (рубидиевый генератор)**: не более ±0.3 мкс в сутки
- **Уход часов в автономном режиме (цезиевый генератор)**: не более ±0.3 мкс в сутки
- **Уход часов в автономном режиме (цезиевый генератор HQ++)**: не более ±0.5 мкс в сутки
...
- **Количество приемников**: возможность установки до 2 приемников одновременно
...
**1. OCXO (Oven-Controlled Crystal Oscillator)**
- **Стандартная поставка**: OCXO-HQ (Stratum 3E)
- **Уход времени в автономном режиме**: не более ±1.5 мкс в сутки
- **Типичное значение случайной составляющей ошибки**: ±5 нс от высокоточного стандарта частоты
- **Применение**: стандартные требования к точности времени

**2. OCXO обычный**
- **Уход времени в автономном режиме**: не более ±20 мкс в сутки
- **Типичное значение случайной составляющей ошибки**: ±5 нс от высокоточного стандарта частоты
- **Применение**: экономичные решения с базовыми требованиями к точности

**3. TCXO (Temperature-Compensated Crystal Oscillator)**
- **Уход времени в автономном режиме**: значительно больше чем OCXO
- **Применение**: экономичные решения с базовыми требованиями к точности

**4. Рубидиевый генератор (аппаратная опция «-RB» под заказ)**
...
**5. Цезиевый генератор (аппаратная опция «-CS» под заказ)**
- **Уход времени в автономном режиме**: не более ±0.3 мкс в сутки
- **Типичное значение случайной составляющей ошибки**: ±5 нс от высокоточного стандарта частоты
- **Применение**: системы с максимальными требованиями к точности

**6. Цезиевый генератор HQ++ (аппаратная опция «-CS+» под заказ)**
- **Уход времени в автономном режиме**: не более ±0.5 мкс в сутки
- **Особенности**: низкий уровень низкочастотных фазовых шумов
- **Типичное значение случайной составляющей ошибки**: ±5 нс от высокоточного стандарта частоты
- **Применение**: системы с требованиями к минимальным фазовым шумам

**Выбор типа генератора:**
- **QANTUM-O**: Генератор OCXO-HQ (стандартная поставка) - ±1.5 мкс в сутки
- **QANTUM-T**: Генератор OCXO обычный (стандартная поставка) - ±20 мкс в сутки
- **QANTUM-RB**: Рубидиевый генератор (поставка под заказ) - ±0.3 мкс в сутки
- **QANTUM-CS**: Цезиевый генератор (поставка под заказ) - ±0.3 мкс в сутки
- **QANTUM-CS+**: Цезиевый генератор с низким фазовым дрожанием (поставка под заказ) - ±0.5 мкс в сутки
