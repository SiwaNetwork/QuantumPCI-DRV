...
|--------------|-------------------------|----------|
| **QANTUM-O** | Генератор OCXO-HQ | Уход времени в автономном режиме не более ±22мкс в сутки (стандартная поставка) |
| **QANTUM-T** | Генератор OCXO-HQ | Уход времени в автономном режиме не более ±22мкс в сутки (стандартная поставка) |
| **QANTUM-RB** | Рубидиевый генератор | Уход времени в автономном режиме не более ±1.5мкс в сутки (поставка под заказ) |
...
- **Уход часов в автономном режиме (OCXO HQ)**: не более ±22 мкс в сутки
- **Уход часов в автономном режиме (рубидиевый генератор)**: не более ±1.5 мкс в сутки
...
**3. Рубидиевый генератор (аппаратная опция «-RB» под заказ)**
...
- **QANTUM-O**: Генератор OCXO-HQ (стандартная поставка)
- **QANTUM-T**: Генератор OCXO-HQ (стандартная поставка)
- **QANTUM-RB**: Рубидиевый генератор (поставка под заказ)
- **QANTUM-CS**: Цезиевый генератор (поставка под заказ)
- **QANTUM-CS+**: Цезиевый генератор с низким фазовым дрожанием (поставка под заказ)
