...
**Бюджетные варианты:**
- **Осциллограф**: Rigol DS6000 (полоса 1 ГГц) - ~$15,000
- **Частотомер**: Rigol DSA800 (350 МГц) - ~$3,000
- **Анализатор фазового шума**: Rigol DSA800 - ~$8,000

**Средний класс:**
- **Осциллограф**: Keysight Infiniium S (полоса 6 ГГц) - ~$50,000
- **Частотомер**: Keysight 53230A - ~$15,000
- **Анализатор фазового шума**: Keysight E5052B - ~$80,000

**Премиум класс:**
- **Осциллограф**: Tektronix DPO70000SX (полоса 70 ГГц) - ~$200,000
- **Частотомер**: Keysight 53230A с внешним эталоном - ~$25,000
- **Анализатор фазового шума**: Rohde & Schwarz FSWP - ~$150,000
