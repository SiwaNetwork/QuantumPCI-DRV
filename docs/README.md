...
Комплексная документация для продукта Quantum-PCI - высокоточной карты синхронизации времени с поддержкой PTP и веб-системой мониторинга.

> 📖 **Главная страница проекта**: См. [основной README](../README.md) в корне репозитория для общего обзора
> 
> 📚 **Руководство по эксплуатации**: См. [РУКОВОДСТВО_ПО_ЭКСПЛУАТАЦИИ_Quantum-PCI.md](РУКОВОДСТВО_ПО_ЭКСПЛУАТАЦИИ_Quantum-PCI.md) для инструкций (оптимизированная версия 2.1, 527 строк)
> 
> 📖 **Полная версия**: См. [РУКОВОДСТВО_ПО_ЭКСПЛУАТАЦИИ_Quantum-PCI.md.ORIGINAL](РУКОВОДСТВО_ПО_ЭКСПЛУАТАЦИИ_Quantum-PCI.md.ORIGINAL) для расширенной документации (5775 строк)

## Новые возможности (2024-2025)

### 🕐 Автономное хранение времени (2025)

Добавлен полный модуль для работы Quantum-PCI как автономного хранителя времени для карт **без GNSS приемников**:

- **📁 Модуль** - [autonomous-timekeeper](../autonomous-timekeeper/README.md)
- **🚀 Автоматическая настройка** - скрипт полной настройки системы
- **📊 Анализ точности** - дрейф < 1 ppm (отличная точность)
- **🔄 Гибридный режим** - NTP + Quantum-PCI fallback
- **📚 Полная документация** - руководства, отчеты, примеры
...
- **🗺️ Roadmap** - http://localhost:8080/api/roadmap (план развития)
...
> ⚠️ **Ограничения**: Текущий драйвер `ptp_ocp` предоставляет ограниченный набор метрик. Детальный мониторинг температуры, питания, GNSS созвездий и расширенные PTP метрики пока недоступны. См. [Roadmap через API](http://localhost:8080/api/roadmap) для планов развития.
...
- [`tools/monitoring-guide.md`](tools/monitoring-guide.md) - Система мониторинга Quantum-PCI
- [`tools/web-monitoring.md`](tools/web-monitoring.md) - Веб-мониторинг и REST API
- [Prometheus Exporter](../quantum-pci-monitoring/api/prometheus-exporter.py) - Экспорт метрик для Grafana
...
> 📊 **Подробная информация о мониторинге** см. [основной README](../README.md#мониторинг) и [quantum-pci-monitoring/README.md](../quantum-pci-monitoring/README.md)
...
- [Веб-мониторинг](../quantum-pci-monitoring/) - Система веб-мониторинга
