...
| Vendor ID | Уникальный ID производителя | 0x1d9b (Facebook), 0x18d4 (Celestica), 0x1ad7 (Orolia) | ✅ |
| Device ID | Уникальный ID устройства | 0x0400, 0x1008, 0xa000 | ✅ |
...
| D3hot | Состояние сна | Через PM callbacks | ✅ |
...
| ├── pci_delay | Задержка PCIe | PTM регистры | ✅ |
| ├── sma1_in/out | SMA1 конфигурация | GPIO регистры | ✅ |
| ├── sma2_in/out | SMA2 конфигурация | GPIO регистры | ✅ |
| ├── sma3_in/out | SMA3 конфигурация | GPIO регистры | ✅ |
| ├── sma4_in/out | SMA4 конфигурация | GPIO регистры | ✅ |
